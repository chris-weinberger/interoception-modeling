...
function ret=find_model_params_OLD(individual, test)
...
global ind typetest exec_data salience_data interoceptive_data exec_corr sal_corr int_corr;
...
modelsal_length = length(model_salience_time_data);
